...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
                ...
                <ul>
                    ...
                    <li class="dropdown">
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo e(route('skrining.index')); ?>">Cek PHBS secara mandiri</a></li>
                            <li><a href="#">IKL mandiri</a></li>
                            <li><a href="<?php echo e(route('ttd.index')); ?>">Pengingat Minum TTD</a></li>
                        </ul>
                    </li>
                </ul>
            ...
            <a href="<?php echo e(route('mitra.index')); ?>" class="appointment-btn scrollto"><span class="d-none d-md-inline"></span> Mitra-Pesantren
                Sehat</a>
            <a href="<?php echo e(route('skrining.index')); ?>" class="appointment-btn scrollto"><span
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active" style="background-image: url(assets/img/slide/berandaa.png)">
          <div class="container">
            ...
            <a href="<?php echo e(route('skrining.index')); ?>" class="btn-get-started scrollto">Skrining Sekarang</a>
          </div>
        </div>
...
<?php /**PATH D:\magang\ikipesat\resources\views/beranda.blade.php ENDPATH**/ ?>