...
<link rel="stylesheet" href="assets/css/style.css">
 ...
 {{-- <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
        ...
        <ul>
          ...
          <li class="dropdown">
            ...
            <ul>
              ...
              <li><a href="#">Pengingat Minum TTD</a></li>
            </ul>
          </li>
        </ul>
      ...
      <a href="#" class="appointment-btn scrollto"><span class="d-none d-md-inline"></span> Mitra-Pesantren Sehat</a>
      <a href="{{ route('skrining.index') }}" class="appointment-btn scrollto"><span class="d-none d-md-inline"></span> Skrining</a>
    </div>
  </header> --}}
  <!-- End Header -->
                    ...
                    <form action="" method="post" class="f1">
                        ...
                        <fieldset>
                            ...
                            <div class="f1-buttons">
                                <a href="{{ route('skrining.index') }}" class="btn btn-warning btn-previous"><i class="fa fa-arrow-left"></i> Sebelumnya</a>
